...
def main(folder=None):
    ...
    for d in TEST:
        ...
        print(f"{d:>6}{F.r2(yb, fp):>12.4f}{F.r2(yb, fm):>10.4f}"
              f"{F.r2(yb, fm) - F.r2(yb, fp):>+13.4f}"
    ...
    for d in UNSEEN:
        ...
        if hi < 0:
            worse.append(d)
        print(f"{d:>6}{F.r2(yb, fp):>15.4f}{F.r2(yb, fm):>10.4f}"
              f"{F.r2(yb, fm) - F.r2(yb, fp):>+13.4f}"
    ...
    for d in FAR:
        ...
        if hi >= 0:
            ext_ok.append(d)
        print(f"{d:>6}{F.r2(yb, fp):>15.4f}{F.r2(yb, fm):>14.4f}"
              f"{F.r2(yb, fm) - F.r2(yb, fp):>+13.4f}"
              + f"[{lo:>+9.5f},{hi:>+9.5f}]".rjust(24))
    ...
    for d in TEST:
        fp = per_delay(own, P, y, idx, d)
        rp, rc, ro = F.r2(yb, fp), F.r2(yb, mk[d]), F.r2(yb, mk3[d])
