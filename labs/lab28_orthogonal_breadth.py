...
def main(folder=None):
    ...
    worst = 0.0
    for d in DELAYS:
        rf = F.r2(yb, walk(own, P, y, idx, d, "FULL"), BENCH)
        rr = F.r2(yb, walk(own, P, y, idx, d, "PC1+REST"), BENCH)
    ...
    for d in DELAYS:
        ...
        r_own, r_pc1 = F.r2(yb, f_own, BENCH), F.r2(yb, f_pc1, BENCH)
        r_rst, r_ful = F.r2(yb, f_rst, BENCH), F.r2(yb, f_ful, BENCH)
