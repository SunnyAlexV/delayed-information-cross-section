...
def main(folder=None):
    ...
    for d in DELAYS:
        _bf, _bs = L.bench_mean(y2f, i2f), L.bench_mean(y2f, i2)
        of = r2(yb2f, IV.walk(own2f, [], y2f, i2f, d), _bf)
        vf = r2(yb2f, IV.walk(own2f, [V2f], y2f, i2f, d), _bf)
        os_ = r2(yb2, IV.walk(own2f, [], y2f, i2, d), _bs)
        vs = r2(yb2, IV.walk(own2f, [V2f], y2f, i2, d), _bs)
    ...
    for d in DELAYS:
        ...
        print(f"{d:>6}{r2(yb3,f_own, _b3):>10.4f}{r2(yb3,f2, _b3):>10.4f}{r2(yb3,f3, _b3):>10.4f}"
              f"{r2(yb3,f3, _b3)-r2(yb3,f2, _b3):>+12.4f}{z:>9.2f}{IV.norm_p(z):>8.3f}")
    ...
    for d in DELAYS:
        ...
        inc = r2(yb3, fb, _b3) - r2(yb3, f3, _b3)
        dl = (yb3 - f3) ** 2 - (yb3 - fb) ** 2
        z = dl.mean() / IV.hac_se(dl)
        if z > 1.96:
            wins.append(d)
        print(f"{d:>6}{r2(yb3,f3, _b3):>10.4f}{r2(yb3,fb, _b3):>10.4f}{inc:>+16.4f}"
