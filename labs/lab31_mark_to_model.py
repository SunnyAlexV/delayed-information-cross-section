...
def main(folder=None):
    ...
    for d in DELAYS:
        ...
        print(f"{d:>6}{F.r2(yb, fa, BENCH) - F.r2(yb, fb, BENCH):>+15.4f}"
    ...
    for d in DELAYS:
        ...
        print(f"{d:>6}{F.r2(yb, fa, BENCH):>10.4f}{F.r2(yb, fb, BENCH):>10.4f}"
              f"{F.r2(yb, fa, BENCH) - F.r2(yb, fb, BENCH):>+13.4f}"
    ...
    for d in DELAYS:
        ...
        print(f"{d:>6}{F.r2(yb, fb, BENCH):>10.4f}{F.r2(yb, fa, BENCH):>10.4f}"
              f"{F.r2(yb, fa, BENCH) - F.r2(yb, fb, BENCH):>+13.4f}"
              + f"[{lo:>+9.5f},{hi:>+9.5f}]".rjust(24))
