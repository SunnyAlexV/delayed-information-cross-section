...
def fieller(num, den, alpha=0.05):
    ...
    # The bandwidth is lab05's measured one, not the automatic rule.  The
    # comment above was already most of the way there: the automatic rule
    # gives 9 lags and truncates while the differential still carries 0.52
    # autocorrelation, so it understated these variances too - less badly
    # than iid did, but in the same direction and for the same reason.
    lag = L.HAC_LAG
