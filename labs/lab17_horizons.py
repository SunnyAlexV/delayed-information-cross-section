...
def main(folder=None):
    ...
    for d in (0, 21, 55):
        ro, _ = skills(y5[i5], walk(own, P, y5, i5, d, 5, False))
        rc, _ = skills(y5[i5], walk(own, P, y5, i5, d, 5, True))
        ro5, _ = skills(yb5, fitrun(d, False))
        rc5, _ = skills(yb5, fitrun(d, True))
    ...
    print("horizon changes, and with it the admissibility cut and the bootstrap block,")
    print("which is held at twice the horizon throughout as in lab05.\n")
    summary = {}
    for h in HORIZONS:
